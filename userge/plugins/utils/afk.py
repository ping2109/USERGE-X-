...
async def handle_afk_incomming(message: Message) -> None:
    ...
    if user_id in USERS:
        if not (USERS[user_id][0] + USERS[user_id][1]) % randint(2, 4):
            if REASON:
                out_str = (
                    f"I'm still either fapping, sleeping, being locked at school.\nAFK Reason: <code>{REASON}</code>\n"
...
AFK_REASONS = (
    "i Am nOt hErE, pInG mE lATeR, nOw d̴̢̛̩̺̺̮̣̼̗̤̫͈̮̉͛͒̋̍̄͂̄̉͑̈́̓̇̍̄̅̈̇̈́̄̆͒́͝͝͝į̴̨̨̡͚̹̟̭̣͕͉̗̜̟̼̭̙̦͈̎̓̌̾̇̐̋̿̌͋̄̀̊͊̐̿̎͋̀̈́͐͘͝͠ͅͅe̵̡̢̢̛̙̲͕̘̻̳͎̹̗̭̻̬̬͍̮̼͓̮͈͕̻̠̭͔̱̯̩͔͕̟̘͉͎̲͛̀̐̿̏͒͗̒̃̀͌̈́͋̉̃̆̈͐̀̾̽̀͂́̈̄̅̌̍̃́͐̿̂͌͗̈͂̄̿́̎̓͊̚̚͜͝͠͠ͅ)
)
